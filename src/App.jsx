...
const LoginScreen = ({ onLogin }) => (
  <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-slate-100 flex flex-col items-center justify-center p-6">
    <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md text-center border border-white/50">
      <div className="bg-emerald-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 rotate-3 shadow-sm">
        <Wallet className="w-10 h-10 text-emerald-600" />
      </div>
      <h1 className="text-3xl font-bold text-slate-800 mb-2 tracking-tight">Budget Planner</h1>
      <p className="text-slate-500 mb-8">Take control of your financial future.</p>
      
      <button 
        onClick={onLogin}
        className="w-full bg-slate-900 text-white p-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition shadow-lg hover:shadow-xl active:scale-95 flex items-center justify-center gap-3 group"
      >
        <div className="bg-white p-1 rounded-full group-hover:scale-110 transition">
    ...
    {/* --- NEW FOOTER WITH YOUR NAME --- */}
    <div className="mt-8 text-center text-slate-400 text-xs font-medium animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
